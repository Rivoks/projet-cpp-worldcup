...
all: main.o playerList.o action.o move.o match.o team.o player.o
	$(CXX) $(CXXFLAGS) main.cc playerList.cc $(ACTION_DIR)/Action.cc $(MOVE_DIR)/Move.cc $(MATCH_DIR)/Match.cc $(TEAM_DIR)/Team.cc $(PLAYER_DIR)/Player.cc $(PLAYER_DIR)/ATK/PlayerATK.cc $(PLAYER_DIR)/DEF/PlayerDEF.cc $(PLAYER_DIR)/GK/PlayerGK.cc -o $(EXEC)
